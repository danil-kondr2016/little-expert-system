 ...
 * <p>
 *     <strong>NB: </strong>
 * Выбор вопроса на данный момент осуществляется с использованием суммы
 * ABS(P(H/E) - P(H/!E)), однако в оригинальной Малой экспертной системе 2.0
 * используется несколько другой способ, который каким-либо образом основан на
 * значениях вероятностей в базе знаний.
 */
